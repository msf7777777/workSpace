...
三. 已知有乒乓球运动员(PingPangPlayer)和篮球运动员(BasketballPlayer),
   ...
   请用所学, 模拟该知识.
 */
public class PingPangPlayer extends Player implements LearnEnglishForPingPang {
    //1.重写从父类继承来的抽象方法eat & study
    @Override
    public void eat() {
        System.out.println(getAge() + "岁,名字叫" + getName() + "的乒乓球运动员吃乒乓球");
    }
    ...
    public void learnEnglishForPingPang() {
        System.out.println("为了出国交流, 乒乓球运动员" + getName() + "都需要学习英语.");
    }
