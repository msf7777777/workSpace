...
public class Test07 {
    ...
    public static void main(String[] args) {
        ...
        //5.看牌
        showCards(林青霞, "林青霞", hm);
        showCards(梅军建, "梅军建", hm);
        showCards(豆腐妹, "豆腐妹", hm);
        showCards(底牌, "底牌", hm);


    }
    public static void showCards(ArrayList<Integer> player,String name, HashMap<Integer,String> hm){
        System.out.print("展示"+ name+"的牌:");
        for (Integer card : player) {
            String cardStr = hm.get(card);
